...
const (
	// AWS_EC2_Instance_Ebs__Type is the CloudFormation type for AWS::EC2::Instance.Ebs.
	AWS_EC2_Instance_Ebs__Type = "AWS::EC2::Instance.Ebs"
)

var (
	// AWS_EC2_Instance_Ebs__PropertiesMap reports all the CloudFormation properties for AWS::EC2::Instance.Ebs.
	AWS_EC2_Instance_Ebs__PropertiesMap = struct {
	...
	// AWS_EC2_Instance_Ebs__PropertiesSlice reports all the CloudFormation properties for AWS::EC2::Instance.Ebs.
	AWS_EC2_Instance_Ebs__PropertiesSlice = []string{
		AWS_EC2_Instance_Ebs__PropertiesMap.DeleteOnTermination,
		AWS_EC2_Instance_Ebs__PropertiesMap.Encrypted,
		AWS_EC2_Instance_Ebs__PropertiesMap.Iops,
		AWS_EC2_Instance_Ebs__PropertiesMap.KmsKeyId,
		AWS_EC2_Instance_Ebs__PropertiesMap.SnapshotId,
		AWS_EC2_Instance_Ebs__PropertiesMap.VolumeSize,
		AWS_EC2_Instance_Ebs__PropertiesMap.VolumeType,
	}
)

// AWS_EC2_Instance_Ebs is a binding for AWS::EC2::Instance.Ebs.
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-instance-ebs.html
type AWS_EC2_Instance_Ebs struct {
...
// New__AWS_EC2_Instance_Ebs initializes a new AWS_EC2_Instance_Ebs.
func New__AWS_EC2_Instance_Ebs() AWS_EC2_Instance_Ebs {
	return AWS_EC2_Instance_Ebs{}
}

// GetType returns the CloudFormation type.
func (AWS_EC2_Instance_Ebs) GetType() string {
	return AWS_EC2_Instance_Ebs__Type
}

// Set__DeleteOnTermination updates property "DeleteOnTermination".
func (t AWS_EC2_Instance_Ebs) Set__DeleteOnTermination(v cfz.Expression[bool]) AWS_EC2_Instance_Ebs {
	t.DeleteOnTermination = v
	return t
}

// SetV__DeleteOnTermination updates property "DeleteOnTermination".
func (t AWS_EC2_Instance_Ebs) SetV__DeleteOnTermination(v bool) AWS_EC2_Instance_Ebs {
	t.DeleteOnTermination = cfz.V(v)
	return t
}

// Set__Encrypted updates property "Encrypted".
func (t AWS_EC2_Instance_Ebs) Set__Encrypted(v cfz.Expression[bool]) AWS_EC2_Instance_Ebs {
	t.Encrypted = v
	return t
}

// SetV__Encrypted updates property "Encrypted".
func (t AWS_EC2_Instance_Ebs) SetV__Encrypted(v bool) AWS_EC2_Instance_Ebs {
	t.Encrypted = cfz.V(v)
	return t
}

// Set__Iops updates property "Iops".
func (t AWS_EC2_Instance_Ebs) Set__Iops(v cfz.Expression[int32]) AWS_EC2_Instance_Ebs {
	t.Iops = v
	return t
}

// SetV__Iops updates property "Iops".
func (t AWS_EC2_Instance_Ebs) SetV__Iops(v int32) AWS_EC2_Instance_Ebs {
	t.Iops = cfz.V(v)
	return t
}

// Set__KmsKeyId updates property "KmsKeyId".
func (t AWS_EC2_Instance_Ebs) Set__KmsKeyId(v cfz.Expression[string]) AWS_EC2_Instance_Ebs {
	t.KmsKeyId = v
	return t
}

// SetV__KmsKeyId updates property "KmsKeyId".
func (t AWS_EC2_Instance_Ebs) SetV__KmsKeyId(v string) AWS_EC2_Instance_Ebs {
	t.KmsKeyId = cfz.V(v)
	return t
}

// Set__SnapshotId updates property "SnapshotId".
func (t AWS_EC2_Instance_Ebs) Set__SnapshotId(v cfz.Expression[string]) AWS_EC2_Instance_Ebs {
	t.SnapshotId = v
	return t
}

// SetV__SnapshotId updates property "SnapshotId".
func (t AWS_EC2_Instance_Ebs) SetV__SnapshotId(v string) AWS_EC2_Instance_Ebs {
	t.SnapshotId = cfz.V(v)
	return t
}

// Set__VolumeSize updates property "VolumeSize".
func (t AWS_EC2_Instance_Ebs) Set__VolumeSize(v cfz.Expression[int32]) AWS_EC2_Instance_Ebs {
	t.VolumeSize = v
	return t
}

// SetV__VolumeSize updates property "VolumeSize".
func (t AWS_EC2_Instance_Ebs) SetV__VolumeSize(v int32) AWS_EC2_Instance_Ebs {
	t.VolumeSize = cfz.V(v)
	return t
}

// Set__VolumeType updates property "VolumeType".
func (t AWS_EC2_Instance_Ebs) Set__VolumeType(v cfz.Expression[string]) AWS_EC2_Instance_Ebs {
	t.VolumeType = v
	return t
}

// SetV__VolumeType updates property "VolumeType".
func (t AWS_EC2_Instance_Ebs) SetV__VolumeType(v string) AWS_EC2_Instance_Ebs {
